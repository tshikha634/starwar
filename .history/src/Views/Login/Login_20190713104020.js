...
import {getUserProfileAction, getUserProfileActionSuccess, getUserProfileActionFailure} from '../../Common/actions/userProfileActions'
import {
  Button,
  Card,
  CardBody,
  ...
  handleChange = (e) => {
    ...
    console.log("result",result)
      ...
      console.log(this.props.getUserProfileActionSuccess)
        ...
        this.props.getUserProfileActionFailure()
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getUserProfileActionSuccess: data => dispatch(getUserProfileActionSuccess(data)),
