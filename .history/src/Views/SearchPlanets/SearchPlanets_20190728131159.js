...
export class SearchPlanets extends Component {
         ...
         async getPlanetList() {
           ...
           try {
             ...
             let params = `=${this.state.name}&page=${
               this.state.offset
             }`;
             let PlanetList = await this.SearchService.getPlanetsByName(
               params
             );
         ...
         renderPlanet = (index,item) => {
return <div>
  <PlanetDetails index = {index} value={item} />
</div>
         }
                           ...
                           <Col>
                             {item.name ? (
                               <span
                                 ...
                                 className="hyperlink"
                                 href=""
                                 onClick={this.redirectTOCreate(index,item)}
                               >
                                 {item.name}
                               </span>
                             ) : (
                 ...
                 <CardBody>
                   ...
                   <div className="pagination">
                     <Pagination
                       ...
                       totalItemsCount={
                         this.props.searchPlanet.data.count
                       }
