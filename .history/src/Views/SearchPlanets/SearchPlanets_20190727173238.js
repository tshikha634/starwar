...
export class SearchPlanets extends Component {
  ...
  renderPlanetList() {
    debugger;
    return (this.props.searchPlanet && this.props.searchPlanet.data.results.map(
        (item, index) => {
          return <ResultComponent index={index} value={item} />;
        }
      ) || null
    );
  }
        ...
        <Card className="borderNone">
          <CardBody>
            <div className="table-responsive">
              ...
              <Row className="row1">
                <Col sm="12">{this.renderPlanetList()}</Col>
              </Row>
            </div>
          </CardBody>
        </Card>
