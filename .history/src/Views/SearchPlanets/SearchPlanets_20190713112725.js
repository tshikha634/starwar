...
} from "../../Common/actions/paymentHistoryAction";
...
export class SearchPlanets extends Component {
  ...
  render() {
    ...
    if (this.props.InvoiceList && this.props.InvoiceList.data) {
      progressbarWidth = parseInt(
        this.calculatePercentage(
          this.props.InvoiceList.data.overDuedateAmount,
          this.props.InvoiceList.data.underDueDateAmount
        )
      );
              ...
              <Table class="table table-bordered table-inverse">
                ...
                <thead>
                  <tr>
                    ...
                    {!MerchantID ? <th width="9%">Merchant ID</th> : null}
                ...
                this.props.InvoiceList.data.rows.length ? (
                  <tbody>{this.renderInvoiceList()}</tbody>
                ) : null} */}
              </Table>
              {/* <div>
                {this.props.InvoiceList.data.rows &&
