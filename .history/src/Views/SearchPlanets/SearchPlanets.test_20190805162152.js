...
let varState = { showPopup: false };
let childWrapper = wrapper.find(PaymentList);
childWrapper.setState(varState);
childWrapper.instance().onCloseButton();
expect(childWrapper.state("showPopup")).toBe(false);
  })