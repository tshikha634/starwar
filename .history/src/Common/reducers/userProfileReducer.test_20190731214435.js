...
// const mockStore = configureMockStore();
 ...
 describe('todos reducer', () => {
  it('should return the initial state', () => {
    expect(userProfileReducer(undefined, {})).toEqual(INITIAL_STATE);
  })
    ...
    it("should handle USER_PROFILE", () => {
        state= {data: [], loading: true, error: false, flag: false }
      // it's empty on purpose because it's just starting to fetch posts
      expect(userProfileReducer(USER_PROFILE, state)).toEqual({
        data: [],
        loading: true,
        error: false,
        flag: false
